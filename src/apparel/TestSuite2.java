...
import org.openqa.selenium.By;
    ...
    public class TestSuite2 extends BaseTest {
        ...
        public void verifyOpenBrowserAndLogIn() throws InterruptedException {
            ...
            Thread.sleep(2000);
            sendTextToElement(By.id("FirstName"), "Prime");   //firstname
            sendTextToElement(By.id("LastName"), "Watford");   //lastname
            sendTextToElement(By.id("Email"), "prime1@gmail.com"); //email id has to be changed before running
            sendTextToElement(By.id("Password"), "test123");  //password
            sendTextToElement(By.id("ConfirmPassword"), "test123");//confirm password
        ...
        public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfullyWithExistingUser() throws InterruptedException {
            hoverToElement(By.xpath("//body[1]/div[6]/div[2]/ul[1]/li[3]/a[1]"));
            ...
            hoverToElement(By.xpath("//span[contains(text(),'Shopping cart')]"));//mousehover on shopping cart
            ...
            Thread.sleep(3000);
            sendTextToElement(By.id("Email"), "prime1@gmail.com"); //email
            sendTextToElement(By.id("Password"), "test123");    //password
            ...
            sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "0789999999"); //phone number
            ...
            sendTextToElement(By.id("CardholderName"), "Mr.M COP");  //name on card
